      ...
      <table>
       <tr>
        <td width="50%">
         <h3>订单号：{{$data->rand}}</h3>
         下单时间<br>
         	<strong class="orange">{{date('Y-m-d H:i:s',$data->time)}}</strong><br>
         用户详情<br>
         	<strong class="orange">{{$data->user}}</strong><br>
         总金额<br>
         	<strong class="orange">{{$data->count}}</strong>
        </td>
    ...
    <div class="gwcpiao">
     <table>
      <tr>
       ...
       <td width="50%"><a href="/zhifu" class="jiesuan">立即支付</a></td>
      </tr>
     </table>
    </div><!--gwcpiao/-->
    </div><!--maincont-->
